...
const Sidebar = (props: { handleClose: Function, emitCloseSidebar: Function }) => {
  return (
    <div className='bg-stone-100 text-stone-900 text-lg min-h-screen py-2 flex flex-col gap-6'>
      ...
      <div className='flex flex-col gap-8 px-6'>
          ...
          <Link href="/assets/Harrison_Kim_Resume.pdf" target="_blank" onClick={() => props.emitCloseSidebar()}>
